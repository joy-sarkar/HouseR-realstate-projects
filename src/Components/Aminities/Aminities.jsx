  ...
  return (
    <div>
      <section className="bg-[#f2f6f7] md:px-14">
        <div>
          <h1 className="text-[3.5rem] font-black text-center text-slate-950 pt-12">
            Building Amenities
          </h1>
        </div>
        <div className="grid md:grid-cols-3 md:gap-5 place-items-center justify-items-center md:py-16 ">
          {Amenities.map((item) => (
            <div
              key={item.id}
              className="md:py-24 md:px-[7.5rem] rounded shadow-2xl flex justify-center items-center duration-500 flex-col group relative hover:bg-[#ff593cad]"
            >
              ...
              <p className="from-neutral-800 text-slate-950 font-bold text-lg pt-4">
                {item.title}
              </p>
